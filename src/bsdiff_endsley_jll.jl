...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import bsdiff_endsley_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4b92dbe6-3cad-5173-b451-9946eb17ce71"))
platforms = [Pkg.Artifacts.unpack_platform(e, "bsdiff_endsley", artifacts_toml) for e in artifacts["bsdiff_endsley"]]
...
if best_platform === nothing
    @debug("Unable to load bsdiff_endsley; unsupported platform $(triplet(platform_key_abi()))")
else
